...
const questions = [
  {
    id: 1,
    name: "Antler IC Interview",
    description: "Answer questions about your startup idea",
    difficulty: "Hard",
    disabled: false,
  },
  {
      ...
      if (upload.ok) {
        ...
        if (results.transcript.length > 0) {
          const prompt = `Please give feedback on my response as a startup founder to the quesiton: ${question} given the following transcript: ${results.transcript
            }. Please give me a feedback whether you would invest based on the response and how I can improve the response? \n\n\ Feedback on the candidate's response:`;
              ...
              {recordingPermission ? (
                <div className="w-full flex flex-col max-w-[1080px] mx-auto justify-center">
                  ...
                  <span className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal mb-4">
                    Asked by the best VC partners at Antler, Y-Combinator, ...
                  </span>
                  <motion.div
                    initial={{ y: -20 }}
                    animate={{ y: 0 }}
          ...
          <div className="w-full h-[40vh] md:w-1/2 md:h-screen bg-[#F1F2F4] relative overflow-hidden">
            ...
            >
              ...
              <div className="bg-white text-[#667380] p-[18px] flex flex-col">
                ...
                {step === 1 &&
                  (selected.name === "Antler IC Interview" ? (
                    <motion.ul
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: -10 }}
